...
for str in ${model_paths[@]}; do
  ...
  python -m presentation.pipelines.pipeline_0.finetune --pt-model $str/pretraining --gpu 2
  
  echo [INFO] Starting CLF $str
  python -m presentation.pipelines.pipeline_0.classify --pt-model $str/pretraining --gpu 2
done