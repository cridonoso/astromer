...
case = sys.argv[4]
astromer_size = sys.argv[5]



if case == 'c':
    project_path = './presentation/experiments/clf/finetuning/{}/c/{}'.format(astromer_size, ds_name)
    start = time.time()
    ...
    project_path = './presentation/experiments/clf/finetuning/{}/ab/{}'.format(astromer_size, ds_name)
